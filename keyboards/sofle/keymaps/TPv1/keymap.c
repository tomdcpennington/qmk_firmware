...
tap_dance_action_t tap_dance_actions[] = {
	...
	// Tap once for Escape, twice for Caps Lock
	[TD_GRV_PRNT] = ACTION_TAP_DANCE_DOUBLE(KC_GRV, KC_PSCR),
	// Tap once for Escape, twice for Caps Lock
 ...
 * |------+------+------+------+------+------| MUTE  |    |  MEH  |------+------+------+------+------+------|
 * | LCTR |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |RAlt  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc | WIN  |LOWER | Enter| /Space  /       \Enter \  |SPACE |RAISE | {    |  }   |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT(
  //,------------------------------------------------.                    ,---------------------------------------------------.
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,             LT(_SWITCH,KC_6), KC_7,   KC_8,    KC_9,    KC_0,    /*KC_GRV*/TD(TD_GRV_PRNT),
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LCTL, KC_Z,   KC_X,    TD(TD_C_COPY),    TD(TD_V_PASTE),    KC_B,  KC_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RALT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_BSPC, KC_LGUI, KC_LOWER, KC_SPC,  KC_ENT   ,     KC_SPC, KC_ENT ,  KC_RAISE, TD(TD_LBRC_HOME), TD(TD_RBRC_END)
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
/*
 * COLEMAK-DH
...
[_ADJUST] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  RGB_TOG, RGB_HUI,RGB_SAI, RGB_VAI, KC_COLEMAKDH,KC_COLEMAKDH,             C(G(KC_LEFT)),KC_NO,KC_NO,C(G(KC_RGHT)),XXXXXXX, XXXXXXX,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_SWITCH] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  TO(0),   TO(1),   TO(2),   TO(3),   TO(4),   TO(5),                      TO(6),   KC_NO,   KC_NO,   KC_NO,   KC_NO,   QK_REBOOT,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  KC_NO,   KC_NO, KC_BRIU,   KC_NO,   KC_NO,   KC_NO,                      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   QK_BOOT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
layer_state_t layer_state_set_user(layer_state_t state) {
	...
	rgblight_set_layer_state(5, layer_state_cmp(state, _DEFAULTS) && layer_state_cmp(default_layer_state,_COLEMAKDH));
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(default_layer_state)) {
        case _QWERTY:
            ...
            break;
        case _COLEMAKDH:
            oled_write_ln_P(PSTR("ClkDH"), false);
            break;
        default:
...
static void print_slave_status_narrow(void) {	
	...
	//oled_write(get_u8_str(global_keycode, '0'), false);
		
	//oled_set_cursor(1,14);
	//clear - 85-128 = 43. 43X3 = 129 wpm max	
	uint8_t i;
	for (i=85;i<=128;i++){//height	
		for (uint8_t x=0;x<30;x++){//width	
			oled_write_pixel(x, i, false);
		}
	}	
	uint8_t top = 128-(get_current_wpm()/3);
	top = top<85?85:top;
	for (i=top;i<=128;i++){//height	
		for (uint8_t x=0;x<30;x++){//width	
			oled_write_pixel(x, i, true);
		}
	}
}
